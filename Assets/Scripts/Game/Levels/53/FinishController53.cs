...
public class FinishController53 : MonoBehaviour
{
    ...
    {
        if (SceneController.usedItemAmount == 4)
            return 3;
        else if (SceneController.usedItemAmount == 5 || SceneController.usedItemAmount == 6)
            return 2;
        else
            return 1;
    }
