...
public class FinishController20 : MonoBehaviour
{
    ...
    {
        if (SceneController.usedItemAmount == 2 || SceneController.usedItemAmount == 1 || SceneController.usedItemAmount == 3 || SceneController.usedItemAmount == 4)
            return 3;
        else if (SceneController.usedItemAmount == 5)
            return 2;
        else
            return 1;
    }
