...
public class FinishController21 : MonoBehaviour
{
    ...
    {
        if (SceneController.usedItemAmount == 2 || SceneController.usedItemAmount == 3 || SceneController.usedItemAmount == 4 || SceneController.usedItemAmount == 1)
            return 3;
