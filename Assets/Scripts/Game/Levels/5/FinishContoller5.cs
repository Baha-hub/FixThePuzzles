...
public class FinishContoller5 : MonoBehaviour
{
    public GameObject finishScreen;
    public GPGSAchievements ach;

    public int CalculateStar()
    {
        if (SceneController.usedItemAmount == 2 || SceneController.usedItemAmount == 3)
            return 3;
        else if (SceneController.usedItemAmount == 4)
            return 2;
        else
            return 1;
    }
