...
public class FinishController56 : MonoBehaviour
{
    ...
    {
        if (SceneController.usedItemAmount == 4 || SceneController.usedItemAmount == 3 || SceneController.usedItemAmount == 2 || SceneController.usedItemAmount == 1)
            return 3;
